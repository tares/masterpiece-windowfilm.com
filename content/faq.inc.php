        	...
        	<div id="aboutUsDesc">
                ...
                <div id="faq_en">
                    ...
                    <div id="FaQField">
                    	<div id="headerBarLatin" class="dropShadow">
                            <div id="longBannerGreen"></div>
                            <p>7. What is the difference between MASTERPIECE window film with other brands ?</p>
                        </div>
                         <div id="AboutUs_table_content" class="dropShadow">
                             <span>
                ...
                <div id="faq_id">
                    ...
                    <div id="FaQField">
                    	<div id="headerBarLatin" class="dropShadow">
                            <div id="longBannerGreen"></div>
                            <p>2. Apakah kaca film MASTERPIECE dapat memberikan perlindungan apabila terjadi pecahnya kaca ?</p>
                        </div>
                         <div id="AboutUs_table_content" class="dropShadow">
                             <span>
                    ...
                    <div id="FaQField">
                    	<div id="headerBarLatin" class="dropShadow">
                            <div id="longBannerGreen"></div>
                            <p>3. Bagaimana cara membersihkan kaca film MASTERPIECE ?</p>
                        </div>
                         <div id="AboutUs_table_content" class="dropShadow">
                             <span>
                    ...
                    <div id="FaQField">
                    	<div id="headerBarLatin" class="dropShadow">
                            <div id="longBannerGreen"></div>
                            <p>4. Apakah dalam pengaplikasian kaca film MASTERPIECE dapat di rangkap dengan kaca film lain ?</p>
                        </div>
                         <div id="AboutUs_table_content" class="dropShadow">
                             <span>
                    ...
                    <div id="FaQField">
                    	<div id="headerBarLatin" class="dropShadow">
                            <div id="longBannerGreen"></div>
                            <p>5. Berapa lama garansi yang diberikan kaca film MASTERPIECE ?</p>
                        </div>
                         <div id="AboutUs_table_content" class="dropShadow">
                             <span>
                    ...
                    <div id="FaQField">
                    	<div id="headerBarLatin" class="dropShadow">
                            <div id="longBannerGreen"></div>
                            <p>6. Apakah keuntungan dari penggunaan kaca film MASTERPIECE ?</p>
                        </div>
                         <div id="AboutUs_table_content" class="dropShadow">
                             <span>
                    ...
                    <div id="FaQField">
                    	<div id="headerBarLatin" class="dropShadow">
                            <div id="longBannerGreen"></div>
                            <p>7. Apa yang membedakan kaca film MASTERPIECE dengan kaca film merk lain ?</p>
                        </div>
                         <div id="AboutUs_table_content" class="dropShadow">
                             <span>
